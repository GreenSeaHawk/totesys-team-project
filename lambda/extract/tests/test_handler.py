...
def test_lambda_handler_success(mock_connect_to_db, mock_extract_table_data, mock_serialise_data,
                                mock_upload_raw_data_to_s3, mock_get_last_ran, mock_update_last_ran_s3,
                                setup_s3_bucket, monkeypatch):
    ...
    result = lambda_handler({}, {}, BUCKET_NAME)
...
@patch("src.handler.connect_to_db")
def test_lambda_handlder_db_connection_failure(mock_connect_to_db, monkeypatch):
    monkeypatch.setattr("src.handler.TABLES", TABLES)  
...
@patch("src.handler.upload_raw_data_to_s3")
@patch("src.handler.serialise_data")
@patch("src.handler.extract_table_data", side_effect=Exception("Data extraction failed."))
@patch("src.handler.connect_to_db")
def test_lambda_handlder_data_extraction_failure(mock_connect_to_db, mock_extract_table_data, mock_serialise_data,
                                mock_upload_raw_data_to_s3, mock_get_last_ran, mock_update_last_ran_s3,
                                setup_s3_bucket, monkeypatch):
...
@patch("src.handler.update_last_ran_s3")
@patch("src.handler.get_last_ran")
@patch("src.handler.upload_raw_data_to_s3", side_effect=ClientError(
    error_response={"Error": {"Code": "500", "Message": "S3 upload failed"}},
    operation_name="PutObject"))
@patch("src.handler.serialise_data")
@patch("src.handler.extract_table_data")
@patch("src.handler.connect_to_db")
def test_lambda_handlder_s3_upload_failure(mock_connect_to_db, mock_extract_table_data, mock_serialise_data,
                                mock_upload_raw_data_to_s3, mock_get_last_ran, mock_update_last_ran_s3,
                                setup_s3_bucket, monkeypatch):
...
@patch("src.handler.upload_raw_data_to_s3")
@patch("src.handler.serialise_data")
@patch("src.handler.extract_table_data", side_effect=Exception("Forced Error."))
@patch("src.handler.connect_to_db")
def test_lambda_handler_closes_db_connection(mock_connect_to_db, mock_extract_table_data, mock_serialise_data,
                                mock_upload_raw_data_to_s3, mock_get_last_ran, mock_update_last_ran_s3,
                                mock_close_db_connection, setup_s3_bucket, monkeypatch):
    monkeypatch.setattr("src.handler.TABLES", TABLES)  

...
resource "aws_s3_bucket_object" "counterparty" {
  bucket = aws_s3_bucket.totesys_data_bucket.id
  key = "counterparty/"
}

resource "aws_s3_bucket_object" "currency" {
  bucket = aws_s3_bucket.totesys_data_bucket.id
  key = "currency/"
}

resource "aws_s3_bucket_object" "department" {
  bucket = aws_s3_bucket.totesys_data_bucket.id
  key = "department/"
}

resource "aws_s3_bucket_object" "design" {
  bucket = aws_s3_bucket.totesys_data_bucket.id
  key = "design/"
}

resource "aws_s3_bucket_object" "staff" {
  bucket = aws_s3_bucket.totesys_data_bucket.id
  key = "staff/"
}

resource "aws_s3_bucket_object" "sales_order" {
  bucket = aws_s3_bucket.totesys_data_bucket.id
  key = "sales_order/"
}

resource "aws_s3_bucket_object" "address" {
  bucket = aws_s3_bucket.totesys_data_bucket.id
  key = "address/"
}

resource "aws_s3_bucket_object" "payment" {
  bucket = aws_s3_bucket.totesys_data_bucket.id
  key = "payment/"
}

resource "aws_s3_bucket_object" "purchase_order" {
  bucket = aws_s3_bucket.totesys_data_bucket.id
  key = "purchase_order/"
}

resource "aws_s3_bucket_object" "payment_type" {
  bucket = aws_s3_bucket.totesys_data_bucket.id
  key = "payment_type/"
}

resource "aws_s3_bucket_object" "transaction" {
  bucket = aws_s3_bucket.totesys_data_bucket.id
  key = "transaction/"
}